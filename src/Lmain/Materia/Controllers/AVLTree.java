...
public class AVLTree {
    ...
    public Node insert(Node node, int value) {
        ...
        System.out.println("Insert Node:"+node.getValue()+" , Balace"+balance);
    ...
    private Node rightRotate(Node nodeR) {
        System.out.println("RightRotate:"+nodeR.getValue()+" , Balace"+getBalance(nodeR));
        Node x = nodeR.getLeft();
        System.out.println("nuevo root after left rotate: "+ x.getValue());
    ...
    private Node leftRotate(Node nodeR) {
        ...
        System.out.println("nuevo root after left rotate: "+ y.getValue());
        Node temp = y.getLeft();
